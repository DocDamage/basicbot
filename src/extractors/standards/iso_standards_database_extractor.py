"""Iso Standards Database Extractor"""
...
class ISOStandardsDatabaseExtractor(BaseExtractor):
    """Extract ISO Standards Database data"""
    ...
    def download(self) -> Optional[Path]:
        """Download ISO Standards Database data"""
    ...
    def parse(self, raw_file: Path) -> List[Dict[str, Any]]:
        """Parse ISO Standards Database data"""

"""Iec Standards Database Extractor"""
...
class IECStandardsDatabaseExtractor(BaseExtractor):
    """Extract IEC Standards Database data"""
    ...
    def download(self) -> Optional[Path]:
        """Download IEC Standards Database data"""
    ...
    def parse(self, raw_file: Path) -> List[Dict[str, Any]]:
        """Parse IEC Standards Database data"""

"""Ghs Classification Database Extractor"""
...
class GHSClassificationDatabaseExtractor(BaseExtractor):
    """Extract GHS Classification Database data"""
    ...
    def download(self) -> Optional[Path]:
        """Download GHS Classification Database data"""
    ...
    def parse(self, raw_file: Path) -> List[Dict[str, Any]]:
        """Parse GHS Classification Database data"""

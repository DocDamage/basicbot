...
class ACGIHTLVsDatabaseExtractor(BaseExtractor):
    """Extract ACGIH TLVs Database data"""
    ...
    def download(self) -> Optional[Path]:
        """Download ACGIH TLVs Database data"""
    ...
    def parse(self, raw_file: Path) -> List[Dict[str, Any]]:
        """Parse ACGIH TLVs Database data"""

...
class NIOSHPocketGuideExtractor(BaseExtractor):
    """Extract NIOSH Pocket Guide data"""
    ...
    def download(self) -> Optional[Path]:
        """Download NIOSH Pocket Guide data"""
    ...
    def parse(self, raw_file: Path) -> List[Dict[str, Any]]:
        """Parse NIOSH Pocket Guide data with enhanced HTML parsing"""

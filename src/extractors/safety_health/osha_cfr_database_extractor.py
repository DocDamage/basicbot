...
class OSHACFRDatabaseExtractor(BaseExtractor):
    """Extract OSHA CFR Database data"""
    ...
    def download(self) -> Optional[Path]:
        """Download OSHA CFR Database data"""

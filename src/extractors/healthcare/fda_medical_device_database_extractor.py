"""Fda Medical Device Database Extractor"""
...
class FDAMedicalDeviceDatabaseExtractor(BaseExtractor):
    """Extract FDA Medical Device Database data"""
    ...
    def download(self) -> Optional[Path]:
        """Download FDA Medical Device Database data"""
    ...
    def parse(self, raw_file: Path) -> List[Dict[str, Any]]:
        """Parse FDA Medical Device Database data"""

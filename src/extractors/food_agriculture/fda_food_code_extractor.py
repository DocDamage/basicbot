...
class FDAFoodCodeExtractor(BaseExtractor):
    """Extract FDA Food Code data"""
    ...
    def parse(self, raw_file: Path) -> List[Dict[str, Any]]:
        """Parse FDA Food Code data with enhanced HTML parsing"""
